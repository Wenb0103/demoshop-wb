...
import com.example.demodanei.mapper.AddressMapper;
...
public class AddressServiceImpl implements IAddressService {
    ...
    @Override
    public void addnew(Address address, String username) throws Exception {
     ...
     */
    private void insert(Address address) throws Exception {
     ...
     * @return 受影响的行数
     */
    private void deleteByAid(Integer aid) throws Exception {
     ...
     * @param uid 用户的id
     */
    private void updateNonDefault(Integer uid) throws Exception {
     ...
     * @param aid 收货地址id
     */
    private void updateDefault(Integer aid) throws Exception {
