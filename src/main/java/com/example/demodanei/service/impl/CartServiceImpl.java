...
public class CartServiceImpl implements ICartService {
    ...
    @Override
    public void addToCart(String username, Cart cart) throws Exception {
    ...
    @Override
    public void reduceNum(Integer uid, String username, Integer cid) throws Exception {
        // 根据参数cid查询数据：findByCid(cid)
        Cart result = findByCid(cid);
        // 判断查询结果是否为null
        if (result == null) {
     ...
     * @param cart 购物车数据
     */
    private void insert(Cart cart) throws Exception {
     ...
     */
    private void updateNum(Integer cid, Integer num, String modifiedUser, Date modifiedTime) throws Exception {
